...
<ul>
    ...
    <li>4. Затем, как вы создадите базу данных, необходимо произвести соответствующие миграции. Нужно зайти в консоль и перейти в корень проекта и прописать следующие команды:<ul>
